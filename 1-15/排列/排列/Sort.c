...
void BenchMank(int* a , int n)
{
    ...
    printf("1->%d",PrintArray(a1,sizeof(a)/sizeof(0)));
	PrintArray(a2,sizeof(a)/sizeof(0));
	PrintArray(a3,sizeof(a)/sizeof(0));
	PrintArray(a4,sizeof(a)/sizeof(0));
	PrintArray(a5,sizeof(a)/sizeof(0));
	PrintArray(a6,sizeof(a)/sizeof(0));
	PrintArray(a7,sizeof(a)/sizeof(0));
	PrintArray(a8,sizeof(a)/sizeof(0));
